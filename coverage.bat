...
if exist ..\Misc-Beta-Test\Test-LargeList\Coverage-LargeList_coverage.xml del ..\Misc-Beta-Test\Test-LargeList\Coverage-LargeList_coverage.xml
"..\Misc-Beta-Test\packages\OpenCover.4.6.519\tools\OpenCover.Console.exe" -register:user -target:"..\Misc-Beta-Test\packages\NUnit.ConsoleRunner.3.9.0\tools\nunit3-console.exe" -targetargs:"..\Misc-Beta-Test\Test-LargeList\bin\x64\Debug\Test-LargeList.dll --trace=Debug --labels=All" -filter:"+[LargeList*]* -[Test-LargeList*]*" -output:"..\Misc-Beta-Test\Test-LargeList\Coverage-LargeList_coverage.xml" -showunvisited
if exist ..\Misc-Beta-Test\Test-LargeList\Coverage-LargeList_coverage.xml ..\Misc-Beta-Test\packages\Codecov.1.1.1\tools\codecov -f "..\Misc-Beta-Test\Test-LargeList\Coverage-LargeList_coverage.xml" -t "4abfe066-5e77-4449-b893-73104119f505"
goto end
